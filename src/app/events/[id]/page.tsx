...
export default function EventDetailsPage({ params: { id } }: SearchParamProps) {
            ...
            <div className="flex flex-col gap-5">
              <div className="flex gap-2 md:gap-3">
                <Image
                  ...
                  height={32}
                />
                <div className="p-medium-16 lg:p-regular-20 flex flex-wrap items-center  gap-5 justify-between w-full">
                  <div className="">
